...
@section('content')
 ...
 <div class="divmainFormlogin">
    ...
    <p class="plogin">Don't worry! Just fill you email and we'll send you a link to reset your password</p>
    <div class="divformlogin">
        ...
        <div>
            <p class="psignup">Back to <a href="{{route('sellerlogin',App()->getLocale())}}"><span class="spansignup">Login</span></a></p>
        </div>
    </form>
    </div>
  </div>
