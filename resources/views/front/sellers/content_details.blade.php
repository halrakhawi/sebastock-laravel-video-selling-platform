...
<div class="Table-SubUser">
    <div class="breadcrumb-holder container-fluid">
        ...
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{route('front.vedios',App()->getLocale())}}">Content</a></li>
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 right">               
            <div class="card-close" style="position: absolute; display: flex;">
                  ...
                  <div class="dropdown itemstop">
                      <form action="{{route('seller.showvideoupdate',request()->route()->parameters['id'])}}"
                              method="get">
                              @csrf
                            <button type="submit" href="" class="dropdown-item edit"><i class="fas fa-edit"></i></button>
                          </form>
                ...
                <div class="dropdown itemstop">
                    ...
                    <!--</button>-->
                     <form action="{{route('seller.videodelete',$video->id)}}"
                              method="post">
                              @csrf
                ...
                <div class="info-channel big-video ">
                  ...
                  <div class=" row second-info  second-info-contantDetails" style="font-size: 20px;">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 DetailsChann">
                      <div class="card-close iconinfo2">      
                        {{-- <div class="dropdown">
                          <button type="button" id="closeCard1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle morebutton"><i class="fas fa-ellipsis-v"></i></button>
                          <div aria-labelledby="closeCard1" class="dropdown-menu dropdown-menu-right has-shadow">
                            <a href="#" class="dropdown-item massage"><i class="far fa-envelope"></i>Send massage</a>
                            </div>
                            </div>  --}}
