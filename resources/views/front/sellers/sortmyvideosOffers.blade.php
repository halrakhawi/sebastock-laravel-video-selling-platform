        ...
        <div class="col-lg-12">
          <div class="card">
              ...
              <div class="card-header align-items-center">
                <h3 class="h4">Offers</h3>
                <div class="d-grid gap-2 col-12 content-filter">
                  @foreach ($cats as $cat)
                  <button type="submit" class="btn btn-outline-danger"><a href="{{route('seller.sortmyvideosOffers','cat-'.$cat->name)}}" class="dropdown-item acatoffer">{{$cat->name}} </a></button>
                  @endforeach
