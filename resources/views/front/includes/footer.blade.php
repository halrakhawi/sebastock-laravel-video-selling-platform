         <!--Start Footer-->
         <a href="https://www.tiktok.com/@stockseba"  target="_blank">
          <div class="divstaticbartiktok">
              <div class="flexstaticbar">
      ...
      <a href="https://www.youtube.com/channel/UCxRCPxDDMPty11Mn4kLmw9g"  target="_blank">
          <div class="divstaticbaryoutube">
              <div class="flexstaticbar">
         ...
         <a href="https://www.facebook.com/stockseba/" target="_blank">
          <div class="divstaticbarface">
              <div class="flexstaticbar">
                  <i class="fab fa-facebook-f"></i>
              </div>
          </div>
      </a>
      <a href="https://twitter.com/sebastock20" target="_blank">
          <div class="divstaticbartwitter">
              <div class="flexstaticbar">
                  <i class="fab fa-twitter"></i>
              </div>
          </div>
      </a>
      <a href="https://www.instagram.com/seba._.stock/" target="_blank">
          <div class="divstaticbarinsta">
              <div class="flexstaticbar">
         ...
         <footer class="footer" style="height:auto">
            ...
            <!--    <button class="btn btn-secondary dropdown-toggle ddlistlanguage" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">-->
            <!--      {{__('Select Language')}}-->
            <!--    </button>-->
            ...
            <!--  @endif-->
            <!--  </div>-->
             @if (get_CurrentUrl()=='sellerprofile')
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="{{url('sellerprofile/'.request()->route()->parameters['id'].'/en')}}">English</a>
                  <a class="dropdown-item" href="{{url('sellerprofile/'.request()->route()->parameters['id'].'/ar')}}">العربية</a>
                  <a class="dropdown-item" href="{{url('sellerprofile/'.request()->route()->parameters['id'].'/es')}}">Española</a>
                ...
                @endif
                <div style="text-align:center; color:#A71B21; margin-bottom:15px; padding-top:15px">
               <a href="{{route('aboutus',App()->getLocale())}}" style=" color:#707070">{{__('know more about our website.')}}<P style=" color:#A71B21; display:inline; font-weight:bold">{{__('About Us')}}</P></a>       
            </div>
            <div class="divpfooter">
            <p class="pfooter">{{__('Copyright')}} <i class="far fa-copyright"></i> 2021 <span class="spanfooter">SEBA</span> </p>
