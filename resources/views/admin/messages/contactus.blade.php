...
<div class="breadcrumb-holder container-fluid">
 ...
 <div class="details-msg" style="background: #fff;">
    <div class="container test">
        <div class="row p-5">
            <div class="col-md-6">
                <h1 style="font-weight: 500;">{{$contactus->name}}</h1>
            </div>
        </div>
        <div class="row px-5">
            <div class="col-md-6">
                <div class=" d-flex"> 
                    {{-- <div class="msg-profile px-3"> <img src="" style="height: 50px;" 
                        alt="..." class="img-fluid rounded-circle"></div> --}}
                    <div class="msg-body">
                      <h3 class="h5">{{$contactus->name}} </h3><span>{{$contactus->email}}</span>
                    </div></div>
            </div>
     
            <div class="col-md-6 d-flex justify-content-around">
                <p class="px-3">{{$contactus->created_at}}</p>
                ...
                <div class="card-close">      
                    <div class="dropdown">
                      ...
                      <div aria-labelledby="closeCard1" class="dropdown-menu dropdown-menu-right has-shadow " x-placement="bottom-end" style=" position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-143px, 24px, 0px);">
                        ...
                        <a href="#" class="dropdown-item edit actionsubadmin2"><i class="fas fa-trash-alt"></i>{{__('delete')}}</a></div>
        ...
        <div class="options row p-3 test">
            ...
            {{-- <div class="col-md-6  pt-5">
                <button type="button" class="btn btn-outline-secondary replay-btn"><i class="fa fa-reply" aria-hidden="true"></i>{{__('Reply')}}</button>
            </div> --}}
            {{-- <div class="col-md-6">
