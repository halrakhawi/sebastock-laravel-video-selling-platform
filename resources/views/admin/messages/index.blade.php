  ...
  <div class="card-close">
    <div class="dropdown itemstop">
      ...
      <div aria-labelledby="closeCard1" class="dropdown-menu dropdown-menu-right has-shadow" style="display: none;">
       <a href="{{route('admin.messagessort','sort-asc')}}" class="dropdown-item ATZ">
               A TO Z</a>
           <a href="{{route('admin.messagessort','sort-desc')}}" class="dropdown-item ZTA">
               Z TO A</a>
      </div>
      </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    @foreach ($messages as $message)
                        @if ($message->usertype == 1||$message->usertype == 2)
