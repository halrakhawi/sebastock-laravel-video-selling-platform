                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                              @foreach ($Adminsellers as $seller)
                              ...
                              <div class="dataTables_paginate paging_simple_numbers" id="example_paginate">
                                ...
                                {{-- <ul class="pagination">
                                  <li class="paginate_button page-item previous disabled" id="example_previous">
                                    <a href="#" aria-controls="example" data-dt-idx="0" tabindex="0" class="page-link">{{$paginator->previousPageUrl()}}</a></li>
