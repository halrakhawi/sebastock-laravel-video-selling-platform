   ...
   <div class="Table-SubUser">
    ...
    <div class="Advertising_details">
        ...
        <div class="container-fluid">
                ...
                <form id="addadv" class="details_Advertising " method="post" action="{{route('admin.Advertisments.update',[$adv->id,App()->getLocale()])}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising ">
                          ...
                          <input type="text" class="form-control" name="title" placeholder="Example: product site" value="{{$adv->title}}">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising">
                      ...
                      <div>
                          ...
                          <input type="radio"  value="1" {{ ($adv->type=="1")? "checked" : "" }} name="type"></input>      
                      </div>
                    <div>
                      <label>{{__('image')}}</label>
                      <input type="radio"  value="2"   {{ ($adv->type=="2")? "checked" : "" }} name="type"></input>   
                    </div>
                     
                    </div>
                    
                    <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising">
                        <p class="top-heading">{{__('Announcement Status')}}</p>
                        <div>
                            <label>{{__('Active')}}</label>
                             <input type="radio" value="1" name="status" {{ ($adv->status=="1")? "checked" : "" }}></input>
                        </div>
                     <div>
                         <label>{{__('Deactive')}}</label>
                          <input type="radio" value="0" name="status" {{ ($adv->status=="0")? "checked" : "" }}></input>
                     </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <img id="blah" src="{{url('Seba/storage/advertisments').'/'.$adv->url}}" alt="your image" />            
                        </div>
                ...
                <button  id="submit" type="submit" class="btn-Accept">{{__('Update')}}</button>
                 </div>
