 ...
 <div class="Table-SubUser">
          ...
          <div class="breadcrumb-holder container-fluid">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">{{__('Advertising Details')}}</li>
            </ul>
            </div>
    ...
    <div class="Advertising_details">
        ...
        <div class="container-fluid">
                ...
                <form class="details_Advertising ">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising ">
                          ...
                          <input type="text" class="form-control" placeholder="Example: product site" value="{{$adv->title}}">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 input_Advertising">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <img src="{{url('Seba/storage/advertisments').'/'.$adv->url}}">                          
                      <!--<input type='file' class="input_btn" onchange="readURL(this);" style="float: left; width: 100%;" />-->
                      </div>
                ...
                <a href="{{route('admin.Advertisments',App()->getLocale())}}" style="display:flex; align-items:center; justify-content:center" class="btn-Accept">{{__('Back')}}</a>
                 </div>
