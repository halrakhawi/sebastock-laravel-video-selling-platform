...
<div class="Table-SubUser">
 ...
 <div class="Report-btn">
  ...
  <a href="{{route('admin.getbuyerReport',App()->getLocale())}}"><button  class="reportactive" >{{__('Buyers')}}</button></a>
  <a href="{{route('admin.contentReport',App()->getLocale())}}"><button class="report1">{{__('Contents')}}</button></a>
  <a href="./Reports_Requests.html"><button class="report1">{{__('Requests')}}</button></a>
      ...
      <div class="row chart-div">
        ...
        <form action="{{route('admin.buyerReport',App()->getLocale())}}" method="post">
            @csrf
              {{-- <div class="date-div">
                  <div class="col-sm-12 col-md-6 col-lg-6">
                  <select name="month" class="option1">
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-6">
                  <select name="year" class="option2" type="submit">
                  <option> Year </option>
