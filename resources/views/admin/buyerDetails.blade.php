            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "> <a href="{{ route('admin.buyers',App()->getLocale()) }}"> {{__('Buyers')}}</a></li>
                        <li class="breadcrumb-item active">{{__('Buyer Details')}}</li>
                    </ul>
                </div>
                    ...
                    <div class="card-close" style="position: absolute; display: flex;">
                        <div class="dropdown itemstop">
                            <button type="button" id="closeCard1" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false" class="dropdown-toggle backicon">
            ...
            <div class="hidediv1">
                ...
                <div class="hidediv1 deletediv">
                    <div class="massage-hidediv1 deletediv2 ">
                        ...
                        <br>
                        <div class="title-hidediv container">
                            <p>Once you press continue, you will permanently delete this user. Are you sure about the
                                deletion process?</p>
                        </div>
                        <div class="datahide container" style="margin-top: 5px;">
                            <div class="actiondiv2" style="margin-bottom: 5px;">
                                <button type="submit" class="continuedetelet"
                                    style="margin:5px !important;">continue</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="left-div2 col-sm-3 col-md-3 col-lg-3">
                                ...
                                <div class="image-div-subAdmin">
                                    ...
                                    <div class="avatar-name">
                                        ...
                                        <p class="avatar-Email" style="font-size: 12px;">{{ $user->emial }}</p>
                                        <div class="buyer-details-icon">
                                            <a href="#" class="dropdown-item massage extra-icon " aria-haspopup="true"
                                                aria-expanded="false" title="Send message" id="myBtn"><i class="far fa-envelope envo"></i></a>
                                        
                                            <a data-toggle="modal" data-target="#activeexampleModal"
                                                class="dropdown-item remove extra-icon" title="Deactivate"> <i
                                                    class="far fa-times-circle envo"></i> </a>
                                         
                                            <a href="#" class="dropdown-item edit extra-icon" title="Delete"
                                                data-toggle="modal" data-target="#deleteexampleModal"><i
                                                    class="fas fa-trash-alt envo"></i></i></a>
                                        </div>
                              ...
                              <div class="channel-div">
                                  <div class="container">
                                      <div class="row" style="width:100%">
                                          ...
                                          @foreach ($userdownloads as $item)
                                              @foreach ($veds as $video)
                                                  @if ($video->id == $item->video_id)
                                                      <div class="box-channles col-12 col-md-6">
                                                          <div class="containt-channel">
                                                              <div class="vedio-channel">
                                                                  <video class="video move" width="100%" controls
                                                                      disablePictureInPicture
                                                                      controlsList="nodownload nofullscreen">
                                                                      <source src="{{ route('file1', $video->url) }}"
                                                                          type="video/mp4">
                                                                  </video>
                                                              ...
                                                              <div class="info-channel">
                                                                  ...
                                                                  <div class="second-info">
                                                                      ...
                                                                      <div class="left-div">
                                                                          <p class="time-info">
                                                                            {{timeInfo(now()->diffInMonths($video->created_at))}}</p>
                                                                      </div>
                       ...
                       <input type="hidden" name="_token" value="{{ csrf_token() }}">
                         <div class="modal-body">
                            <div class="input-group input-group-sm mb-3  Mainform">
                                <input type="text" class="form-control form1 form-input" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="To" value="{{ $user->email }}" name="to">
                            </div>
                            <div class="input-group input-group-sm mb-3 Mainform">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" style="text-align: center;">
                                                            ...
                                                            <p class="pDelete">Do you really want to accept this user? This
                                                                process cannot be undone.</p>
                                                            <button type="button" class="btn btn-secondary"
                                                                style="margin-bottom: 10px"
                                                                data-dismiss="modal">Cancel</button>
                                                            <form action="{{ route('admin.userActivate', $user->id) }}"
                                                                method="post">
                                                                @csrf
                                                                <button type="submit" class="btn btn-danger"
                                                                    style="margin-bottom: 10px">Accept</button>
                                                            </form>
                                                        </div>
                                                        <!-- <div class="modal-footer">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="text-align: center;">
                                                        ...
                                                        <p class="pDelete">Do you really want to delete this user? This
                                                            process cannot be undone.</p>
                                                        <button type="button" class="btn btn-secondary"
                                                            style="margin-bottom: 10px" data-dismiss="modal">Cancel</button>
